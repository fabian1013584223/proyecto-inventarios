  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ marginBottom: 40 }}>
          <Text style={{ color: '#0a58ca', fontSize: 24, textAlign: 'center',lineHeight:'2'}}>Bodega</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ShowProductos')}>
          ...
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowProveedor')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Proveedores</Text>
                </TouchableOpacity>
            </View>
            <View 
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
           BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowDetalleFacturaProveedor')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Factura Proveedor</Text>
                </TouchableOpacity>
            </View >
      </ScrollView>
