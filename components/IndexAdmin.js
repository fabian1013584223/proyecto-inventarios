  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ marginBottom: 40 }}>
          <Text style={{ color: '#0a58ca', fontSize: 30, textAlign: 'center',lineHeight:'2'}}>Administrador</Text>
          ...
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
                <TouchableOpacity onPress={() => navigation.navigate('ShowUsuarios')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Usuarios</Text>
                </TouchableOpacity>
            </View>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
        <TouchableOpacity onPress={() => navigation.navigate('ShowCliente')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Cliente</Text>
                </TouchableOpacity>
            </View>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowProveedor')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Proveedor</Text>
                </TouchableOpacity>
            </View>
          ...
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('Categoria')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Categoria</Text>
                </TouchableOpacity>
            </View>
      </ScrollView>
